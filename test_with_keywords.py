...
def check_related_articles(eid_list):
     ...
     # Selected keywords
    keywords=['power transformer', 'distribution transformer','dynamic thermal rating',
              'dynamic transformer rating','IEC 60076-7','loading capability',
              'thermal rating','insulation ageing','insulation aging','current limit',
              'temperature limit','transformer','Transformer']
